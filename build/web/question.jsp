    ...
    <body>
        ...
        <main id="main">
                ...
                <div class="container">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <ol>
                            ...
                            <li><a href="profile.jsp" >Topics</a></li>
                            <li><%= topic %></li>
                        </ol>
                    </div>
            ...
            <section>
                <div class="container">
                    <div class="progress">
                    <div class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100" style="width: <%= (mdao.getMarkedQuestionsCountTopic(user.getId(),topic) * 100)/ qdao.getTotalQuestionsCountTopic(topic)%>%">   
                    <%= mdao.getMarkedQuestionsCountTopic(user.getId(), topic) %> / <%= qdao.getTotalQuestionsCountTopic(topic) %></div>
                    </div>
                    <div class="row">
                                                ...
                                                <tbody>
                                                    <%
                                                        ...
                                                        for (Questions q : qlist) {
                                                            ...
                                                            if (q.getQtopic().equalsIgnoreCase(topic)) 
                                                            {   
                                                    %>
        ...
        <script>
            ...
            <%
                ...
                for (MQ q : mq) 
                {
                    if(user.getId() == q.getUid() && qdao.getQTopic(q.getQid()).equals(topic))
                    {
                        %>
                            
                        onCheck(<%= q.getQid() %>);
                        count = <%= mdao.getMarkedQuestionsCountTopic(user.getId(), topic) %>
